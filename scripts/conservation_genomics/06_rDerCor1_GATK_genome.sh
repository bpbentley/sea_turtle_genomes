#!/bin/bash
#BSUB -J "rDerCor_GATK_genome[1-28]"
#BSUB -e ./logs/06_GATK_genome/rDerCor_GATK_genome.%I.err
#BSUB -o ./logs/06_GATK_genome/rDerCor_GATK_genome.%I.log
#BSUB -W 90:00
#BSUB -n 16
...
NAME=rDerCor_genome # unique name needed if running multiple pipelines on different data, as files will be written to same directory, and will over-write if not unique.
...
OUTDIR=/project/uma_lisa_komoroske/Blair/rDerCor1/GATK_out/genome
TEMPDIR=/project/uma_lisa_komoroske/Blair/rDerCor1/GATK_out/genome/temp
