#!/bin/bash
#BSUB -J "CheMyd_GATK_nonexons[1-28]"
#BSUB -e ./logs/GATK/nonexons/CheMyd_GATK_nonexons.%I.%J.err
#BSUB -o ./logs/GATK/nonexons/CheMyd_GATK_nonexons.%I.%J.log
#BSUB -W 90:00
#BSUB -n 20
...
OUTDIR=/project/uma_lisa_komoroske/Blair/WGR_for_genome/GATK_out/CheMyd/${NAME}/nonexons
TEMPDIR=/project/uma_lisa_komoroske/Blair/WGR_for_genome/GATK_out/CheMyd/${NAME}/nonexons/temp
REFDIR=/project/uma_lisa_komoroske/Blair/refs/rCheMyd1_20210528
WINDIR=/project/uma_lisa_komoroske/Blair/refs/rCheMyd1_20210528/nonexons
